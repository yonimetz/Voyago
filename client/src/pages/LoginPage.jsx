...
{/* צד ימין: כרטיס זכוכית (Glassmorphism) שמשתלב בסרטון */}
          <div className="w-full max-w-md mx-auto bg-white/10 backdrop-blur-md p-10 rounded-[2.5rem] shadow-2xl border border-white/20">
            <div className="text-center mb-8">
              ...
              <p className="text-white/80 font-medium">Welcome back! Please login.</p>
            </div>
            ...
            <p className="mt-8 text-center text-white/80 text-sm font-medium">
              ...
              <Link to="/register" className="ml-2 text-white font-bold hover:text-blue-300 hover:underline transition-colors">Sign Up</Link>
            </p>
          </div>
        </div>
