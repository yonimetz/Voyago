    ...
    <div className="min-h-screen font-sans text-slate-900 bg-white overflow-x-hidden" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <header className="absolute top-0 w-full z-50 p-6 lg:px-12 flex justify-between items-center">
        <h1 className="text-3xl font-extrabold text-white tracking-tight drop-shadow-md">
          Voyago<span className="text-[#0770E8]">.</span>
        </h1>
        ...
        <div className="relative z-10 max-w-7xl w-full mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full max-w-md mx-auto bg-white/5 backdrop-blur-sm p-10 rounded-[2.5rem] shadow-2xl border border-white/20">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full p-4 bg-white/10 border border-white/20 text-white placeholder-white/50 rounded-2xl focus:ring-2 focus:ring-[#0770E8] outline-none transition-all"
                  required
                />
              </div>
              <div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-[#0770E8] hover:bg-[#0770E8]/90 text-white font-bold py-4 rounded-2xl transition-all transform active:scale-95 disabled:bg-slate-500/50 mt-2"
              >
            ...
            <p className="mt-8 text-center text-white/80 text-sm font-medium">
              ...
              <Link to="/register" className="mx-2 text-white font-bold hover:text-[#0770E8] hover:underline transition-colors">{t('login_signup', 'Sign Up')}</Link>
            </p>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 bg-[#0770E8]/10 text-[#0770E8] rounded-2xl flex items-center justify-center mb-6 shadow-sm">
      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-[2.5rem] p-8 md:p-12 max-w-md w-full shadow-2xl animate-fade-in text-center">
          ...
          <div className="w-20 h-20 bg-[#0770E8]/10 text-[#0770E8] rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-sm">
          ...
          <div className="flex flex-col gap-3">
            <a 
              ...
              className="inline-flex items-center justify-center w-full bg-[#0770E8] hover:bg-[#0770E8]/90 text-white font-bold py-4 rounded-2xl transition-all shadow-md shadow-[#0770E8]/20 transform active:scale-95 text-sm tracking-wide"
            >
