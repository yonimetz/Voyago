  ...
  return (
    ...
    >
      ...
      <div className="h-48 bg-slate-200 flex items-center justify-center relative overflow-hidden">
        ...
        {imageUrl ? (
          <>
            ...
            />
            {/* שכבת כהות עדינה כדי שהטקסטים יבלטו מעל התמונה */}
            <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors"></div>
          </>
        ) : (
          // מצב טעינה או אם אין תמונה - מציג את המטוס הקודם
          <div className="h-full w-full bg-gradient-to-br from-blue-100 to-indigo-50 flex items-center justify-center">
      ...
      <div className="p-6 flex-1 flex flex-col">
        <h3 className="text-xl font-bold text-slate-800 group-hover:text-blue-600 transition-colors capitalize">
          {trip.destination}
        </h3>
        ...
        <div className="mt-auto w-full bg-slate-50 text-center text-slate-700 font-bold py-3.5 rounded-2xl group-hover:bg-blue-600 group-hover:text-white transition-all duration-300 border border-slate-100">
          {t('view_itinerary')}
        </div>
      </div>
    </div>
